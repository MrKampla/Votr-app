...
const validatePollCreationParams = (state: CreatePollStore, pollFactory: VotrPollFactory, ethereum: Web3) => {
  if (!pollFactory) {
              ...
              <FramedSection title={'Properties'} minWidth="100%">
                ...
                <FramedSectionButton
                  onClick={() => {
                    ...
                    if (validatePollCreationParams(state, pollFactory, ethereum)) {
                      // pollFactory.methods
                      //   .createPoll(...params)
                      //   .send({ from: account });
                    }
